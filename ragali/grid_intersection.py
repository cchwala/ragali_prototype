# Copy-paste code from pycomlink, exactly this file
# https://github.com/pycomlink/pycomlink/blob/28d54a40dd3203e4985020a57d7f016c4ac1e39f/pycomlink/spatial/grid_intersection.py
# Adjusted so that DataArray can be passed instead of coordinates
...
def calc_sparse_intersect_weights_for_several_cmls(
    ...
    Parameters
    ----------
    ds_cmls : xr.Dataset or xr.DataArray
        A CML Dataset or DataArray that has all location info the the cml_ids.
    x_grid : 2D array
    ...
    da_intersect_weights.coords["cml_id"] = ds_cmls.cml_id
